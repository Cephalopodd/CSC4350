/**
 * This data access object is used to access the db from the front desk menu and
 * the profile/reservation menu
 */
package hms.model;
...
public class FrontDeskDAO {
     ...
     * creates a reservation and returns a reservationNumber
     */
    ...
    /**
     * Gets a guest credit card from reservation confirmation number
     * @param confirmation
     * @return 
     */
    ...
    /**
     * Retrieves a guest profile from a profile ID
     * @param profileID
     * @return 
     */
    ...
    /**
     * Returns profiles that match search criteria in Profile DTO
     * @param dto
     * @return 
     */
    ...
    /**
     * Parses a profile from result set
     * @param rs
     * @return
     * @throws Exception 
     */
    ...
    /**
     * Returns a reservation, given a reservation number
     * @param resNo
     * @return 
     */
    ...
    /**
     * Registers a credit card on a guest folio
     * @param profileID
     * @param cc
     * @return 
     */
    ...
    /**
     * Returns all guests that are currently checked in
     * @return 
     */
